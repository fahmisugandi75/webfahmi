    ...
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div aria-hidden="true" className="absolute inset-x-0 -top-3 -z-10 transform-gpu overflow-hidden px-36 blur-3xl">
        <div
          ...
          className="mx-auto aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#ff80b5] to-[#ded39d] opacity-30"
        />
      </div>
      <div className="mx-auto max-w-2xl text-center lg:max-w-4xl">
        <h2 className="text-base font-semibold leading-7 text-orange-600">Pricing</h2>
        <p className="mx-auto mt-2 max-w-lg text-pretty text-4xl font-medium tracking-tight text-gray-950 sm:text-5xl">
          The right price for you, whoever you are
        </p>
      </div>
      <p className="mx-auto mt-8 max-w-2xl text-center text-lg leading-8 text-gray-600">
        ...
        {tiers.map((tier, tierIdx) => (
          ...
          >
            ...
            <Button
              ...
              className={classNames('mt-8 w-full sm:mt-10')}
              asChild
            >
